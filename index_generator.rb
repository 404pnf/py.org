...
=begin
    #p links
>> separate_path_filename('/home/path/to/file.txt')
=> #<MatchData "/home/path/to/file.txt" 1:"/home/path/to/" 2:"file.txt">
>> separate_path_filename('/home/path/to/file.txt')[1]
=> "/home/path/to/"
>> separate_path_filename('/home/path/to/file.txt')[1].last
NoMethodError: undefined method `last' for "/home/path/to/":String
from (irb):176
from /usr/bin/irb:12:in `<main>'
>> separate_path_filename('/home/path/to/file.txt')[1].split('/')
=> ["", "home", "path", "to"]
>> separate_path_filename('/home/path/to/file.txt')[1].split('/').last
=> "to"
=end
